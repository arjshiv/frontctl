...
function usage() {
  return {
    ...
    commands: [
      ...
      "frontctl link add CONVERSATION_ID --url URL [--name NAME] [--actor NAME] [--reason WHY] [--yes] [--json]",
      ...
      "frontctl draft create|compose [--to EMAIL] [--cc EMAIL] [--bcc EMAIL] [--subject \"...\"] --body \"...\"|--body-file draft.md [--json] (preview-only)",
